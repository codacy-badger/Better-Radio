<template>
  <div class="home">
        <div class="skewed-hero gradient-default" style="height: 400px;">
          <div class="container">
            <p>
              <strong>Hero</strong>
            </p>
    ...
    <div class="container">
        <contentCard style="height: 300px;margin-bottom: 4em;">Large card wrapper for larger pieces of content</contentCard>
      <b-row>
        <b-col>
          <p>
   ...
   <b-row>
    ...
    <br><br>
      ...
      <b-row>
        <b-col>
          <p>
            <strong>Callout Wide Card</strong>
          </p>
          <p>
            Primary
            <code>primary</code>
